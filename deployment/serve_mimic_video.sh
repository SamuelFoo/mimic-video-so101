...
# Video backbone
VIDEO_MODEL_PATH="${VIDEO_MODEL_PATH:-${REPO_ROOT}/data/video-model/checkpoints/model/iter_000001410_fused.pt}"
ACTION_MODEL_PATH="${ACTION_MODEL_PATH:-${REPO_ROOT}/data/action-model-v2/checkpoints/model/iter_000000800.pt}"
